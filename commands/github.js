...
class EnhancedGitHubVisualizer {
  ...
  async drawBrandingFooter(ctx, x, y) {
    ...
    ctx.font = '16px Inter';
    ctx.textAlign = 'right';
    ctx.fillText('Generated with EnhancedGitHub Visualizer', x, y);
  }
...
module.exports = {
  name: 'github',
  description: 'Generate enhanced GitHub profile visualization',
  ...
  async execute(bot, msg, args) {
    ...
    try {
      ...
      await bot.sendPhoto(chatId, profileImage, {
        caption: `🎨 Enhanced GitHub Profile Visualization for @${username}\nGenerated on ${new Date().toLocaleDateString()}\n\nFeaturing modern design and interactive elements!`,
        parse_mode: 'HTML'
      });
